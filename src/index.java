...
//        JMenu contactItem = new JMenu("Contact Us");
//        JMenu helpItem = new JMenu("Help");
//        JMenu profileItem = new JMenu("Profiles");
...
public class index extends JFrame {
    ...
    public index() {
        ...
        JPanel footerLinks = new JPanel(new FlowLayout(FlowLayout.RIGHT, 20, 15));
        footerLinks.setOpaque(false);

        String[] linkNames = {"Privacy Policy", "Terms of Service", "Help Center"};
        for (String name : linkNames) {
            JLabel link = new JLabel(name);
            link.setForeground(new Color(200, 200, 200));
            link.setFont(new Font("Arial", Font.PLAIN, 13));
            link.setCursor(new Cursor(Cursor.HAND_CURSOR));
            footerLinks.add(link);
        }
        footer.add(footerLinks, BorderLayout.EAST);

        add(footer, BorderLayout.SOUTH); // Footer stays at the bottom of the window
        // ======================================================================
